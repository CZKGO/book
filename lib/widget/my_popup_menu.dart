...
double _kMenuScreenPadding = 8.0;
...
class PopupMenuDivider extends MyPopupMenuEntry<Null> {
...
class MyPopupMenuButton<T> extends StatefulWidget {
  ...
  final double kMenuScreenPadding;
...
class _MyPopupMenuButtonState<T> extends State<MyPopupMenuButton<T>> {
  ...
  Widget build(BuildContext context) {
    assert(debugCheckHasMaterialLocalizations(context));
    _kMenuScreenPadding = widget.kMenuScreenPadding;
